    ...
    return (
        <div className="w-full bg-white text-center h-1/10 flex flex-row drop-shadow-[0_4px_6px_rgba(0,0,0,0.3)] fixed top-0 z-50">
            ...
            <div className="p-4 text-center h-full flex flex-row w-3/5">
                ...
                <button onClick={() => signOut({ callbackUrl: "/" })} className="bg-[#a80404] text-white p-2 rounded-lg w-1/5 hover:text-[#0438A8] hover:bg-white hover:border hover:cursor-pointer transition-all duration-300 delay-50">
                    <Link href="/login">
                        Sign Out
                    </Link>
                </button>
